...
class PermitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permit" do
    assert_difference('Permit.count') do
      post permits_url, params: { permit: { name: @permit.name, needed_reputation: @permit.needed_reputation } }
    end
  ...
  test "should update permit" do
    patch permit_url(@permit), params: { permit: { name: @permit.name, needed_reputation: @permit.needed_reputation } }
