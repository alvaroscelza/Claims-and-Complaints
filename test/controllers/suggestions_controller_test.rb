...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { date_time: @suggestion.date_time, description: @suggestion.description, user_id: @suggestion.user_id } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { date_time: @suggestion.date_time, description: @suggestion.description, user_id: @suggestion.user_id } }
